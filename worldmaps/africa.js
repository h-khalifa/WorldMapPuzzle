export const Africa = {
    ...
    excluded:[
        'Mauritius','Comoros','Seychelles','Cabo Verde','Sao Tome & Principe'
    ],
    others:[
        'Mayotte', 'Réunion', 'aint Helena, Ascension and Tristan da Cunha'
    ]
}